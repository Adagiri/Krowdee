    ...
    return (
        ...
        >  
            <Flex
                w="100%"
                h={
                    position === 1 ? firstBarHeight : 
                    position === 2 ? secondBarHeight : 
                    position === 3 ? thirdBarHeight : null
                }                
                bgGradient={position === 1 ? "linear(to-b,  #4E54C8, #8F94FB)" : position === 2 ? "linear(to-b, #AD5389, #3C1053)" : position === 3 ? "linear(to-b, #0987A0, #054450)" : null}
